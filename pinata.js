...
const main = async () => {
  const imageStream = fs.createReadStream("./images/IFME_1.jpeg");
...
const jsonToPinata = async (metaData) => {
  try {
    const baseUrl = "https://gateway.pinata.cloud/ipfs/QmVkQgJAbHtv34SkpnxSkgoxwUoPiSL6qf5q9j8QLCD4bR"; // Pinata에 Metadata를 저장하고 나면 얻을 수 있는 ipfs hash값을 엔드포인트로 넣어야 합니다.
